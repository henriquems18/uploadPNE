...
<html class="no-js" lang="pt-br">
	...
	<?php
				...
				<div id="paginacao">
					...
					<h3 style="text-align: center">Vaga Publicada!</h3>
					</div>
				</div>
				<?php
				endif;
				...
				?>
		<form id="formulario" method="post" action="cadastrovagas.php">
			...
			<div class="col-md-12">
				<div class="row">
					<div class="basic-information">
						...
						<div class="col-md-9 col-sm-9">
							<div class="profile-content">
									...
									<ul class="information">
										<li><span>Cargo:</span><input id="cargo" required name="cargo" type="text"/></li>
										...
										<li><span>Estado</span><input required id="uf" name="uf" maxlength="2" type="text"/></li>		<li><span>Salário R&#x00024;:</span><input id="salario" required name="salario" type="text" placeholder="1000,00" onKeyUp="mSalario(this);"/></li>
										<li>
										<span>Tipo da Vaga:</span>
										<select class="selectpicker border-right" id="vaga" required name="vaga" >
										...
										<li><span>Carga Horária:</span><input id="horario" required name="horario" type="text"/></li>
										<li><span>Deficiência:</span><input id="deficiencia" required name="deficiencia" type="text"/> <br> Descreva quais deficiência especifica para este cargo como por exemplo Auditivo, Fisica, Mental, Visual ou outros. </li>
									</ul>
								</div>
							</div>
						</div>
						<div class="panel panel-default">
							<div class="panel-heading">
								<i class="fa fa-user fa-fw"></i> Sobre a Vaga
												...
												<!-- /.panel-heading -->
							<div class="panel-body">
							<textarea required name="sobre" placeholder="Descreva um pouco sobre o trabalho que precisará ser feito."></textarea><br>
							</div>
						</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">							
							<ul>
								<li><input id="requisito1" name="requisito1" type="text"/></li>
								<li><input id="requisito2" name="requisito2" type="text"/></li>
								<li><input id="requisito3" name="requisito3" type="text"/></li>
								<li><input id="requisito4" name="requisito4" type="text"/></li>
								<li><input id="requisito5" name="requisito5" type="text"/></li>
							</ul>
							</div>
						</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">							
							<ul>
								<li><input id="beneficio1" name="beneficio1" type="text"/></li>
								<li><input id="beneficio2" name="beneficio2" type="text"/></li>
								<li><input id="beneficio3" name="beneficio3" type="text"/></li>
								<li><input id="beneficio4" name="beneficio4" type="text"/></li>
								<li><input id="beneficio5" name="beneficio5" type="text"/></li>
				...
				<div id="paginacao">
					<div style="width: 238px; height: inherit; 	margin: 0 auto;">
					<input type="submit" class="btn brows-btn1" value="Postar"/>
					<input type="reset" class="btn brows-btn1" value="limpar"/>
					</div>

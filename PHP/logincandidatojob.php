					...
					<div class="basic-information">
						...
						<div class="col-md-9 col-sm-9">
							<div class="profile-content">
									...
									<input required id="emailempresa" name="emailempresa" type="hidden" value="<?php echo($row_vagas['emailempresa']);?>" >
									<input required id="cargo" name="cargo" type="hidden" value="<?php echo($row_vagas['cargo']);?>" >
...
<div id="centralizarbotao">
					<button class="btn brows-btn" name="View Job">Candidatar-se!</button>

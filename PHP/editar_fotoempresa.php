...
<!-- Inicio da Navegação  -->
	...
	<div class="container">		
		<form id="formulario" method="post" action="mudar_fotoempresa.php" enctype="multipart/form-data">
			...
			<div class="col-md-12">
				...
				<h2>Editar Foto!</h2>					
					...
					<input id="cnpj" name="cnpj" type="hidden" maxlength="14" onKeyDown="javascript: fMasc( this, mCNPJ);" value="<?php echo($row_empresa['cnpj']);?>"/>							

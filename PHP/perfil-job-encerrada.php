...
<html class="no-js" lang="pt-br">
	...
	<?php
		...
		<form id="formulario" method="post" action="reativarvaga.php">
			...
			<div class="row heading">
				...
				<p style="text-align: center">Atualize os dados e reative esta vaga!</p>
			</div>
						...
						<div class="col-md-9 col-sm-9">
							<div class="profile-content">
									...
									<ul class="information">
										...
										<li><span>Deficiência:</span><input id="deficiencia" name="deficiencia" type="text" value="<?php echo($row_vagas['deficiencia']);?>" /> <br> Descreva quais deficiência especifica para essa este cargo como por exemplo Auditivo, Fisica, Mental, Visual ou outros. </li>
									</ul>
								</div>
							</div>
						</div>
				...
				<div id="paginacao">
					...
					<input type="submit" class="btn brows-btn1" value="Reativar Vaga"/>

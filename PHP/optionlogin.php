		...
		<section class="login-wrapper">
			<div class="container">
				<div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
					...
					<h2>Faça seu Login! <br>Você é um Candidato ou Empresa?</h2>					
				</div>
				<div id="paginacao">
					<div id="centralizarbotao3">
					<input type="button" class="btn brows-btn1" onclick="window.location='logincandidato.php';" value="Candidato"/>
					<input id="botaoempresa" type="button" class="btn brows-btn1" onclick="window.location='loginempresa.php';"  value="Empresa"/>
					</div>

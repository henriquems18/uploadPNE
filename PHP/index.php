    ...
    <body>
		...
		<section class="main-banner" style="background:#242c36 url(img/slider-01.jpg) no-repeat">
			<div class="container">
				...
				?>
				 	<h3 style="color:white">Sentiremos sua falta, volte a qualquer hora se cadastrando novamente!</h3>
				<?php
				endif;
				unset($_SESSION['excluido']);
				?>
						<h2>Comece sua carreira agora!</h2>
					<form id="formulario" method="post" action="pesquisar_vagas.php">
						<fieldset>
		...
		<form id="formulario" method="post" action="enviar_vagas.php" enctype="multipart/form-data" autocomplete="off">
			<div class="container">
				<div class="row">
					...
					<div class="input-group">
						...
						class="form-control" placeholder="Digite seu endereço de email...">

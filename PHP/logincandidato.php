		...
		<section class="login-wrapper">
			...
			<?php
				...
				?>
						<div id="paginacao">
							<div style="width:195px; height:inherit; margin:0 auto;">
								<p style="text-align: center"><b>CPF OU SENHA INVÁLIDOS!</p>
							</div>
						</div>
				<?php
				endif;
				...
				<div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
					<form action="logincand.php" method="POST">
						<img class="img-responsive" alt="logo" src="img/logo.png">
						<div class="row heading">
							<h2>Bem-vindo Candidato!</h2>
						</div>
						<input type="text" name="cpf" maxlength="14" class="form-control input-lg" placeholder="CPF" onKeyDown="javascript: fMasc( this, mCPF);">
						<input type="password" name="senha" class="form-control input-lg" placeholder="Senha">
						
						
						<label><a href="esqueci_a_senha.php">Esqueceu sua senha?</a></label>
						
						<button type="submit" class="btn btn-primary">Entrar</button>
						<p>Não possui conta? <a href="new-candidate.php">Criar uma conta agora</a></p>
					</form>
				</div>
			</div>
		</section>

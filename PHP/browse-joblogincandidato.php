		...
		<section class="jobs">
			<div class="container">
				...
				<div class="companies">
					...
					$max_links = 2;
					echo "<a href='browse-joblogincandidato.php?pagina=1' style='padding: 11px;'>Primeira</a>";
					
					for($pag_ant = $pagina-$max_links; $pag_ant <= $pagina - 1; $pag_ant ++){
						if($pag_ant >= 1){
						echo "<a href='browse-joblogincandidato.php?pagina=$pag_ant'  style='margin-left: 10px'> $pag_ant</a>";	
						}
					}
					echo "<a href='browse-joblogincandidato.php?pagina=1' style='margin-left: 10px'> $pagina</a>";
					
					for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep ++){
						if($pag_dep <= $quantidade_pg){
							echo "<a href='browse-joblogincandidato.php?pagina=$pag_dep' style='margin-left: 10px'>$pag_dep</a>";
						}
					}
					echo "<a href='browse-joblogincandidato.php?pagina=$quantidade_pg' style='margin-left: 10px; padding: 11px;'> Ultima</a>";
